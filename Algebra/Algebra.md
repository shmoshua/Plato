...
- **Related definition**: A ***$R$-subalgebra*** is a subring $S$ of $R'$ s.t. $\varphi_{R'}(R)\subseteq S$. 
- **Related definition**: For any $M\subseteq S$, $R[M]$ is the ***$R$-subalgebra generated by $M$***, given by: $$R[M]:=\bigcap_{M\subseteq T, T\text{ subalgebra}}^{}T=\left\{  \sum_{I}^{}a_{I}c_{1}^{i_{1}}\dots c_{n}^{i_{n}}:a_{I}\in R, c_{i}\in M\text{ where }a_{I}=0\text{ for almost every }I  \right\}$$ ^ab903c
