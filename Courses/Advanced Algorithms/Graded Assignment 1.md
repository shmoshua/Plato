...
Now assume that $\left| E_{R} \right|,\left| E_{B} \right|< m/3$. Then, $$|E_{R}|+|E_{B}|\leq \left\lceil \frac{m}{3}\right\rceil $$and $|E_{R}|+|E_{B}|\le  \frac{2}{3}m-1$. Therefore, $|E_{V}|\ge \frac{m}{3}+1$. Now we will analyze the probability for a single instance of the randomized coloring. Let $X$ denote the number of edges for which we did not receive a point. Then, 
