...
2. We have that:  $$z_{c}^\top Lz_{c}=(z-\alpha1)^\top L (z-\alpha 1)=z^\top Lz-2\alpha L  1+\alpha^{2} 1^\top L 1=z^\top Lz$$Further, $$z^\top _{c}D z_{c}=z^\top Dz -2\alpha d^\top z+\alpha^{2} \text{vol}(V)$$