...
3. **Claim 3: $\widehat{\mathbb{Q}_{p} / \mathbb{Z}_{p}}\cong \underset{ \longleftarrow }{ \lim }\widehat{A_{-n}}$**:
   Let $\underset{ \longleftarrow }{ \lim }\widehat{A_{-n}}$ denote the inverse limit, i.e. $$ \underset{ \longleftarrow }{ \lim }\widehat{A_{-n}}:=\left\{  \left.(\gamma_{n})_{n}\in \prod_{n\geq 1}^{}\widehat{A_{-n}}\ \right|\ \gamma_{n+1}|_{A_{-n}}=\gamma_{n}, \forall n\geq 1  \right\}$$ Then, consider the map: $$\Phi:\widehat{\mathbb{Q}_{p} / \mathbb{Z}_{p}}\to\underset{ \longleftarrow }{ \lim }\widehat{A_{-n}},\gamma\mapsto(\gamma|_{A_{-n}})_{n}$$We have that $\gamma|_{A_{-n}}$ is a continuous homomorphism and $\gamma|_{A_{-n}}\in \widehat{A_{-n}}$. Further, one can easily check that $\Phi$ is an isomorphism.
   
4. **Claim 4: $\underset{ \longleftarrow }{ \lim }\widehat{A_{-n}}\cong \mathbb{Z}_{p}$**.
   Firstly, we show that $\underset{ \longleftarrow }{ \lim }\widehat{A_{-n}}\cong \underset{ \longleftarrow }{ \lim }\widehat{\mathbb{Z} / p^n \mathbb{Z}}$ where for $(\psi_{n})_{n}\in \underset{ \longleftarrow }{ \lim }\widehat{\mathbb{Z} / p^n \mathbb{Z}}$ and $0\leq x<p^n$, $\psi_{n+1}(px+p^{n+1}\mathbb{Z})=\psi_{n}(x+p^n\mathbb{Z})$. Let $J_{n}$ be the isomorphism from $\mathbb{Z} / p^n\mathbb{Z}$ to $A_{-n}$ from claim 1. Then, $$\underset{ \longleftarrow }{ \lim }\widehat{A_{-n}}\to \underset{ \longleftarrow }{ \lim }\widehat{\mathbb{Z} / p^n \mathbb{Z}},(\gamma_{n})_{n}\mapsto(\gamma_{n}\circ J_{n})_{n}$$which is well-defined as for $0\leq x<p^n$, $p^nJ_{n+1}(px+p^{n+1}\mathbb{Z})=J_{n+1}(0)=0$ and $J_{n+1}(px+p^{n+1}\mathbb{Z})\in A_{-n}$. Therefore, $$\gamma_{n+1}(J_{n+1}(px+p^{n+1}\mathbb{Z}))=\gamma_{n}(J_{n+1}(px+p^{n+1}\mathbb{Z}))=\gamma_{n}(J_{n}(x+p^n \mathbb{Z}))$$where the bijectivity follows from that of $J_{n}$. 
   
   It is left to show that $\mathbb{Z}_{p}:=\underset{ \longleftarrow }{ \lim } \mathbb{Z} /p^n\mathbb{Z}\cong \underset{ \longleftarrow }{ \lim }\widehat{\mathbb{Z} / p^n \mathbb{Z}}$. As $\mathbb{Z} / p^n \mathbb{Z}$, it is finite abelian and $\mathbb{Z} / p^n\mathbb{Z}\cong \widehat{\mathbb{Z} / p^n \mathbb{Z}}$To check that they are compatible similar to above, let $(x_{n})_{n}\in \mathbb{Z}_{p}$ and $(t\mapsto \exp(2\pi i x_{n }t / p^n))$ the corresponding element in the inverse limit of $\widehat{\mathbb{Z} / p^n\mathbb{Z}}$. Then, for $0\leq y<p^n$, $$\exp(2\pi ix_{n+1}py / p^{n+1})=\exp(2\pi ix_{n+1}y / p^{n})=\exp(2\pi ix_{n} y / p^n)$$as $x_{n+1}\equiv_{p^n}x_{n}$. This shows the claim that $\widehat{\mathbb{Q}_{p} / \mathbb{Z}_{p}}\cong \mathbb{Z}_{p}$. 

Now, we show that $\Psi$ is a topological group isomorphism. 
