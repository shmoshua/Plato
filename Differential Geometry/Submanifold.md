...
> 3. [[Indefinite Orthogonal Group|$\text{O}(p,q)$]] $\leq \text{GL}(p+q,\mathbb{R})$ is a regular $n(n-1) /2$-submanifold of $\text{GL}(n,\mathbb{R})$ where $n:=p+q$.
