...
>    
>    Conversely, let $v\in \text{Der}_{p}C^\infty(M)$. Then, 
> 	1. **Claim: for $g\in C^\infty(M)$ with $g \equiv 1$ in a neighborhood of $p$, we have $v( fg)=v(f)$ for all $f\in C^\infty(M)$.**
