...
---
> [!lemma] Proposition 3
> Let $A$ be a Banach algebra and $I\subseteq A$ a closed [[Ideal (Ring)|ideal]]. Then, 
> 1. the quotient Banach space $A / I$ together with the quotient $\mathbb{C}$-algebra structure is a Banach algebra.
...
> 	Let $\varepsilon>0$ and $u,v\in I$ s.t. 
