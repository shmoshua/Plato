...
>	   2. For any $\omega\in \mathcal{B}_{\widehat{A}}$, from the multiplicity$$E(\omega)^{2}=E(\omega)E(\omega)=\Phi(\chi_{\omega})\Phi(\chi_{\omega})=\Phi(\chi_{\omega})=E(\omega)$$
> 
