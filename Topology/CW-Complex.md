...
- **Related definition**: $K^{(n)}$ is called the ***$n$-th skeleton*** of $K$. ^4a1e20
- **Related definition**: A CW-complex $K$ is called  ^f9c65b
...
- **Related definition**: For $\sigma\in I_{n}$, ^cd3e75
...
- **Remark**: By definition,  $U\subseteq K$ is open/closed if and only if for all $n\geq 0$, $U\cap K^{(n)}$ is open/closed in $K^{(n)}$. ^e35b2a
- **Related definition**: A ***subcomplex*** of a CW complex $K$ is a subspace $K'\subseteq K$ is a union of open cells $U_{\sigma}$ for $\sigma\in I'_{n}\subseteq I_{n}$ s.t. $K_{\sigma}\subseteq K'$ for all $\sigma\in I'_{n}$.  ^adf6a6
- **Related definition**: A continuous function $g:K\to L$ between CW-complexes is a ***cellular map*** if $g(K^{(n)})\subseteq L^{(n)}$ for all $n\geq 0$.   ^e53981
---
##### Properties
> [!lemma] Proposition 1
